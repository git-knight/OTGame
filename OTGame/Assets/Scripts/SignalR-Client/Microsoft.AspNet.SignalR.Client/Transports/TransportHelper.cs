...
namespace Microsoft.AspNet.SignalR.Client.Transports
{
    public class TransportHelper
    {
        ...
        public virtual Task<NegotiationResponse> GetNegotiationResponse(IHttpClient httpClient, IConnection connection, string connectionData)
        {
            ...
            return httpClient.Post(negotiateUrl, connection.PrepareRequest, isLongRunning: false)
                            ...
                            .Then(raw =>
                            {
                                ...
                                var data = NegotiationResponse.FromJson(JSON.Parse(raw));
                                return data;
                            });
        }
        ...
        public static bool VerifyLastActive(IConnection connection)
        {
            ...
            if (DateTime.UtcNow - connection.LastActiveAt >= connection.ReconnectWindow)
            {
                ...
                connection.Stop(new TimeoutException(String.Format(CultureInfo.CurrentCulture, "Resources.Error_ReconnectWindowTimeout {0} {1}",
