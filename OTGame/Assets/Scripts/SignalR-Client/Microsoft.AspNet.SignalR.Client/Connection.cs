...
namespace Microsoft.AspNet.SignalR.Client
{
    ...
    public class Connection : IConnection, IDisposable
    {
        ...
        private Task Negotiate(IClientTransport transport)
        {
            ...
            return transport.Negotiate(this, _connectionData)
                            .Then(negotiationResponse =>
                            {
                                ...
                                _disconnectTimeout = TimeSpan.FromSeconds(10);//negotiationResponse.DisconnectTimeout);
                                _totalTransportConnectTimeout = TransportConnectTimeout + TimeSpan.FromSeconds(10);//negotiationResponse.TransportConnectTimeout);
                                ...
                                {
                                    _keepAliveData = new KeepAliveData(TimeSpan.FromSeconds(negotiationResponse.KeepAliveTimeout.GetValueOrDefault()));
        ...
        void IConnection.OnReceived(JSONNode message)
        {
        ...
        [SuppressMessage("Microsoft.Design", "CA1062:Validate arguments of public methods", MessageId = "0", Justification = "This is called by the transport layer")]
        protected virtual void OnMessageReceived(JSONNode message)
        {
            if (Received != null)
            {
        ...
        {
            request.UserAgent = "SignalRClientUnity";
